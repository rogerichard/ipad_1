...
<head>
  <meta charset="utf-8">
  <title>Perfil de Roger Mamani</title>
...
<a name="top"></a>
    ...
    <header>
      <img src="https://placeimg.com/100/100/animals" alt="Drawing of Jane Smith" class="profile-image">
      <h1 class="tag name">Hola, yo soy Roger Mamani.</h1>
      <h2 class="tag name">Soy de Ipad.</h2>
    ...
    <footer>
      <ul>
        ...
        <li><a href="http://www.google.com.pe" class="social linkedin" target="_black">LinkedIn</a></li>
